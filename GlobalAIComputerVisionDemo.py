...
'''
微软认知服务中的Computer Vision实例。

准备工作:
    - 1. 安装 Computer Vision SDK:
      pip install --upgrade azure-cognitiveservices-vision-computervision
    - 2. 创建目录，存放图片: 
      在应用程序的根目录创建“resources”文件夹.
      前往以下链接下载图片，或者自己准备图片:
        https://github.com/Azure-Samples/cognitive-services-sample-data-files/tree/master/ComputerVision/Images
      将以下 7 张图片放入 "resources" 目录: 
        faces.jpg, gray-shirt-logo.jpg, handwritten_text.jpg, landmark.jpg, 
        objects.jpg, printed_text.jpg and type-image.jpg

以下示例包含的功能包括:
    - 图片描述，Describe Image
    - 图片类别，Categorize Image
    - 图片标记，Tag Image
    - 人脸检测，Detect Faces
    - 低俗内容检测，Detect Adult or Racy Content
    - 色彩检测，Detect Color Scheme
    - 名人、地标检测，Detect Domain-specific Content (celebrities/landmarks)
    - 目标检测，Detect Objects
    - 商标检测，Detect Brands
    - 生产缩略图，Generate Thumbnail
    - 手写体、OCR识别，Batch Read File (recognize both handwritten and printed text) 
    - 印刷体识别，Recognize Printed Text with OCR
...
'''
1. 本地图片描述，Describe an Image - local
...
# <snippet_describe>
'''
2. URL图片描述， Describe an Image - remote
This example describes the contents of an image with the confidence score.
'''
...
'''
3.本地图片分类， Categorize an Image -  local
...
# <snippet_categorize>
'''
4. URL 图片分类， Categorize an Image - remote
...
# <snippet_faces>
'''
8.URL图片人脸检测，Detect Faces - remote
...
'''
9.本地图片低俗内容检测，Detect Adult or Racy Content - local
...
# <snippet_adult>
'''
10.本地图片低俗内容检测，Detect Adult or Racy Content - remote
...
# <snippet_remoteimage>
remote_image_url = "https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1154301988,2980705628&fm=26&gp=0.jpg"
# </snippet_remoteimage>
# Call API with URL and features
...
'''
11.本地图片色彩检测，Detect Color - local
...
# <snippet_color>
'''
12.URL图片色彩检测，Detect Color - remote
...
'''
13. 本地图片地标检测，Detect Domain-specific Content - local
...
local_image_path_landmark = "resources\\greatwall.jpg"
...
# <snippet_celebs>
'''
14. URL图片名人和地标检测，Detect Domain-specific Content - remote
...
'''
15. 本地图片目标检测，Detect Objects - local
...
# <snippet_objects>
'''
16. URL图片目标检测，Detect Objects - remote
...
'''
17.本地图片商标检测，Detect Brands - local
This example detects common brands like logos and puts a bounding box around them.
'''
print("===== Detect Brands - local =====")
# Open image file
local_image_path_shirt = "resources\\logo.jpg"
...
# <snippet_brands>
'''
18.URL图片商标检测，Detect Brands - remote
This example detects common brands like logos and puts a bounding box around them.
'''
...
'''
19.本地和URL图片缩略图生成，Generate Thumbnail
...
'''
20.本地手写识别，Batch Read File, recognize handwritten text - local
...
# <snippet_read_call>
'''
21.URL印刷体识别，Batch Read File, recognize printed text - remote
...
'''
22. 本地OCR识别，Recognize Printed Text with OCR - local
...
'''
23. URL OCR识别，Recognize Printed Text with OCR - remote
This example will extract, using OCR, printed text in an image, then print results line by line.
'''
